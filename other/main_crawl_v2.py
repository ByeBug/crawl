...
class ReadThread(threading.Thread):
    def __init__(self, crawler_id, cursor, wait_crawl_q, db_semaphore):
        super().__init__()
    ...
    def generate_tail(self, crawler_id):
        if crawler_id == 8:
    ...
    def run(self):
        ...
        # 根据爬取人id生成 unique尾号
        tail = self.generate_tail(self.crawler_id)
        ...
        while 1:
            ...
            self.cursor.execute(sql, (limit_date, tail))
    ...
    def run(self):
        ...
        while 1:
            try:
                ...
                logger1.info('+++++{} crawling ({})'.format(self.thread_name, name))
...
readThread = ReadThread(crawler_id, cursor, wait_crawl_q, db_semaphore)
